...
export class NotificationManager {
  ...
  static success(
    ...
    return NotificationManager.show(NotificationType.SUCCESS, message, options);
  }
  ...
  static error(
    ...
    return NotificationManager.show(NotificationType.ERROR, message, options);
  }
  ...
  static warning(
    ...
    return NotificationManager.show(NotificationType.WARNING, message, options);
  }
  ...
  static info(
    ...
    return NotificationManager.show(NotificationType.INFO, message, options);
  }
  ...
  static throttled(
    ...
    if (NotificationManager.pendingNotifications.has(key)) {
      return;
    }
    ...
    const timeout = setTimeout(() => {
      NotificationManager.pendingNotifications.delete(key);
    }, throttleMs);

    NotificationManager.pendingNotifications.set(key, timeout);
  }
  ...
  static clearThrottled(key: string): void {
    const timeout = NotificationManager.pendingNotifications.get(key);
    if (timeout) {
