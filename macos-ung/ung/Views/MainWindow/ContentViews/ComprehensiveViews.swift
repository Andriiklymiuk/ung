        ...
        Button(action: { action?() }) {
            ...
            .background(
                RoundedRectangle(cornerRadius: Design.Radius.sm)
                    .fill(isHovered ? Design.Colors.backgroundTertiary(colorScheme) : Design.Colors.backgroundSecondary(colorScheme))
            )
            ...
            ForEach(options, id: \.0) { option in
                Button(action: {
                    ...
                    Text(option.1)
                        ...
                        .foregroundColor(selection == option.0 ? Design.Colors.textPrimary : Design.Colors.textSecondary)
        ...
        VStack(spacing: Design.Spacing.lg) {
            ...
            HStack(spacing: Design.Spacing.sm) {
                ...
                Button(confirmTitle, action: onConfirm)
                    .buttonStyle(DSPrimaryButtonStyle(color: destructive ? Design.Colors.error : Design.Colors.primary))
            }
        }
