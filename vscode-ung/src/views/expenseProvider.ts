...
export class ExpenseItem extends vscode.TreeItem {
    ...
    private getCategoryIcon(category: string): vscode.ThemeIcon {
        ...
        return new vscode.ThemeIcon(iconName, new vscode.ThemeColor('charts.purple'));
    }
}
...
export class ExpenseProvider implements vscode.TreeDataProvider<ExpenseItem> {
    ...
    private buildTreeItems(expenses: ExpenseItem[]): ExpenseItem[] {
        ...
        summaryItem.iconPath = new vscode.ThemeIcon('graph', new vscode.ThemeColor('charts.red'));
        ...
        addItem.iconPath = new vscode.ThemeIcon('add', new vscode.ThemeColor('charts.green'));
        addItem.command = {
