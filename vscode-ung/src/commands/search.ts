...
export class SearchCommands {
  ...
  async universalSearch(): Promise<void> {
    const quickPick = vscode.window.createQuickPick<
      SearchResult & vscode.QuickPickItem
    >();
  ...
  private async loadAllData(): Promise<
    Array<SearchResult & vscode.QuickPickItem>
  > {
  ...
  private async loadInvoices(): Promise<
    Array<SearchResult & vscode.QuickPickItem>
  > {
    ...
    switch (type) {
      ...
      case 'contract':
        return [
          ...
          {
            label: '$(file-pdf) Generate PDF',
            command: 'ung.generateContractPDF',
          },
